  ...
  const facilities = [
    {
      ...
      title: "Swimming Pool",
      description:
        "Outdoor infinity pool with stunning city views and poolside bar service",
    },
    {
      icon: (
        <svg
      ...
      description:
        "State-of-the-art gym equipment available 24/7 with personal trainers",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Fine dining with international cuisine and signature cocktails",
    },
    {
      icon: (
        <svg
      ...
      title: "Spa & Wellness",
      description:
        "Relaxing spa treatments, massage therapy, and wellness programs",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Modern meeting spaces with advanced AV equipment for events",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      description:
        "24-hour assistance for all your needs and local recommendations",
    },
    {
      icon: (
        <svg
      ...
      description: "Comfortable shuttle service to and from the airport",
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        ...
        >
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">
            Our team is ready to help you plan your perfect stay. Contact us for
