...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Content Container */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-20 md:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-160px)]">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <motion.h1
                  ...
                  className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight outfit relative"
                >
              ...
              <motion.h2
                ...
                className={`text-2xl md:text-3xl lg:text-4xl font-medium outfit flex items-center gap-2 ${
              ...
              >
                ...
                <motion.span
                  ...
                  className="inline-block w-0.5 h-8 md:h-10 bg-teal-400"
                />
              </motion.h2>
            </div>
            ...
            <motion.p
              ...
              className={`text-lg md:text-xl max-w-xl leading-relaxed outfit font-light ${
            ...
            <motion.button
              ...
              className="relative inline-flex items-center gap-3 bg-gradient-to-r from-teal-600 to-emerald-600 text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl shadow-teal-500/50 hover:shadow-2xl hover:shadow-teal-500/60 transition-all duration-300 outfit group overflow-hidden"
            >
              <motion.span
            ...
            >
              ...
              >
                <p className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-teal-400 to-emerald-400 bg-clip-text text-transparent outfit">
                  {hotelsCount}+
                </p>
                <p
                  className={`text-sm mt-1 outfit ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}
                >
                  Hotels
                </p>
              </motion.div>
      ...
      <div
        id="search-form"
        className={`relative py-20 md:py-24 px-4 md:px-8 lg:px-16 transition-colors duration-500 ${
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2
              className={`text-3xl md:text-4xl font-bold mb-4 outfit ${
          ...
          <motion.form
            ...
            viewport={{ once: true }}
            onSubmit={onSubmit}
            className={`rounded-3xl shadow-xl border p-6 md:p-8 transition-colors duration-500 ${
              isDarkMode
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              ...
              <div className="space-y-3">
                <label
                  ...
                  className={`flex items-center gap-3 font-semibold outfit text-sm md:text-base ${
                ...
                <input
                  ...
                  type="text"
                  className={`w-full rounded-xl border-2 px-4 py-3 text-sm md:text-base outline-none focus:ring-2 transition-all duration-300 outfit ${
                    isDarkMode
